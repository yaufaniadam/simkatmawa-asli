			...
			<div class="md-accordion accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
				...
				<div class="card">
					...
					<div class="card-header header-card" role="tab" id="headingOne">
						...
						<!-- Heading -->
						<h5 class="mt-1 mb-0" >
							<span >Tambah Anggota Kelompok Wirausaha</span>
				...
				<div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
					<div class="card-body">
						...
						<?php echo form_open_multipart('Transaksi/input_anggota_wirausaha_2'); ?>
									...
									<div class="col-sm">
										...
										<?php if($cek==1){
											...
											<div class="alert alert-danger" role="alert">
												Mahasiswa Yang Bersangkutan Sudah Menjadi Anggota Pada Kelompok Wirausaha Ini.
											</div>
						...
						<?php echo form_open_multipart('Transaksi/tambah_anggota_wirausaha'); ?>
