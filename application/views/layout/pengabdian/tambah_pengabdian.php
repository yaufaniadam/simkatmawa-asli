			...
			<div class="md-accordion accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
				...
				<div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
					<div class="card-body">
						...
						<?php echo form_open_multipart('Transaksi/tambah_pengabdian'); ?>
								...
								<div class="row">									
									<div class="col-sm">
										...
										<div class="md-form form-sm">
											<input type="text" id="input2" name="judul" value="" maxlength="50" class="form-control form-control-sm" required>
											<label for="input2">Judul Pengabdian</label>
										</div>

										<div class="md-form form-sm">
											<input type="text" id="input4" name="kelompok-sasaran"  value="" maxlength="50" class="form-control form-control-sm" required>
											<label for="input4">Kelompok Sasaran</label>
										</div>

										<div class="md-form form-sm">
											<input type="text" id="input5" name="organisasi-pelaksana"  value="" maxlength="50" class="form-control form-control-sm" required>
											<label for="input5">Nama Organisasi Pelaksana</label>
										</div>

										<div class="md-form form-sm">
											<input type="text" id="input3" maxlength="4" name="tahun-kegiatan" value="" class="form-control form-control-sm" onkeypress="return hanyaAngka(event)" required>
											<label for="input3">Tahun Kegiatan</label>
										</div>

										
										<div class="md-form form-sm">
											<input type="text" id="input6" name="jumlah-mahasiswa"  value="" maxlength="30" class="form-control form-control-sm" onkeypress="return hanyaAngka(event)" required >
