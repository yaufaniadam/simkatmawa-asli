			...
			<div class="md-accordion accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
				...
				<div class="card">
					...
					<div class="card-header header-card" role="tab" id="headingOne">
						...
						<!-- Heading -->
						<h5 class="mt-1 mb-0" >
							<span >Dosen Pembimbing Prestasi Mandiri</span>
									...
									<div class="col-sm">
										...
										<div class="card">
											...
											<div class="card-body">
												...
												<input type="hidden" id="mandiri" name="mandiri" value="<?=$id_mandiri;?>" class="form-control form-control-sm" readonly>
...
<script type="text/javascript">
    ...
    {
    	var mandiri = document.getElementById('mandiri').value;
    	$.ajax({
    		url:"<?php echo base_url(); ?>Transaksi/fetch_1",
    		method:"POST",
    		data:{query:query, mandiri:mandiri},
